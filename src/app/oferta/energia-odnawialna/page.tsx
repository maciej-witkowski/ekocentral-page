...
const service = services.find((s) => s.slug === "energia-odnawialna")!;

export const metadata: Metadata = {
  title: "Energia odnawialna – pompy ciepła, panele solarne",
  description: service.seo.description,
};

export default function EnergiaOdnawialnaPage() {
  return (
    <>
