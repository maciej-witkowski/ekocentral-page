...
const service = services.find((s) => s.slug === "technika-grzewcza")!;

export const metadata: Metadata = {
  title: "Nowoczesne rozwiązania grzewcze dla budownictwa",
  description: service.seo.description,
};

export default function TechnikaGrzewczaPage() {
  return (
    <>
